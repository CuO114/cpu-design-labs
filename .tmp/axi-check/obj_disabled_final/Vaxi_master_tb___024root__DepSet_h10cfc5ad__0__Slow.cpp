...
#endif
            VL_FATAL_MT("axi_master_tb.sv", 4, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vaxi_master_tb___024root___ctor_var_reset(Vaxi_master_tb___024root* vlSelf) {
    ...
    vlSelf->axi_master_tb__DOT__ic_rdata = VL_RAND_RESET_I(32);
    ...
    vlSelf->axi_master_tb__DOT__dc_rdata = VL_RAND_RESET_I(32);
