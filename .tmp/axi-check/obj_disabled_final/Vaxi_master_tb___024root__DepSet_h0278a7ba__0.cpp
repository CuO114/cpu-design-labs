...
VL_INLINE_OPT VlCoroutine Vaxi_master_tb___024root___eval_initial__TOP__Vtiming__0(Vaxi_master_tb___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((((0x20cU != vlSelf->axi_master_tb__DOT__araddr) 
                       | (0U != (IData)(vlSelf->axi_master_tb__DOT__arlen))) 
                      | (2U != (IData)(vlSelf->axi_master_tb__DOT__arsize))) 
                     | (1U != (IData)(vlSelf->axi_master_tb__DOT__arburst))))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:112: Assertion failed in %Naxi_master_tb: bad DCache AR request\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 112, "");
    }
    co_await vlSelf->__VtrigSched_h2fb1e198__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(posedge axi_master_tb.clk)", 
    ...
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->axi_master_tb__DOT__arvalid))))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:114: Assertion failed in %Naxi_master_tb: ARVALID did not wait for ARREADY\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 114, "");
    }
    co_await vlSelf->__VtrigSched_h2fb1e249__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge axi_master_tb.clk)", 
    ...
    if (VL_UNLIKELY((0xd0000000U != vlSelf->axi_master_tb__DOT__dc_rdata))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:126: Assertion failed in %Naxi_master_tb: DCache burst assembly failed\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 126, "");
    }
    ...
    if (VL_UNLIKELY(((0x100U != vlSelf->axi_master_tb__DOT__araddr) 
                     | (0U != (IData)(vlSelf->axi_master_tb__DOT__arlen))))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:133: Assertion failed in %Naxi_master_tb: bad ICache AR request\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 133, "");
    }
    co_await vlSelf->__VtrigSched_h2fb1e249__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge axi_master_tb.clk)", 
    ...
    if (VL_UNLIKELY((0x10000000U != vlSelf->axi_master_tb__DOT__ic_rdata))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:145: Assertion failed in %Naxi_master_tb: ICache burst assembly failed\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 145, "");
    }
    ...
    if (VL_UNLIKELY((((0x300U != vlSelf->axi_master_tb__DOT__awaddr) 
        ...
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:157: Assertion failed in %Naxi_master_tb: bad write request\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 157, "");
    }
    co_await vlSelf->__VtrigSched_h2fb1e249__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge axi_master_tb.clk)", 
    ...
    if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->axi_master_tb__DOT__awvalid)) 
                           | (IData)(vlSelf->axi_master_tb__DOT__wvalid))))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:162: Assertion failed in %Naxi_master_tb: AW/W handshakes are not independent\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 162, "");
    }
    co_await vlSelf->__VtrigSched_h2fb1e198__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(posedge axi_master_tb.clk)", 
    ...
    co_await vlSelf->__VtrigSched_h2fb1e198__0.trigger(0U, 
                                                       ...
                                                       163);
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->axi_master_tb__DOT__awvalid))))) {
        VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:164: Assertion failed in %Naxi_master_tb: AWVALID did not wait for AWREADY\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("axi_master_tb.sv", 164, "");
    }
    co_await vlSelf->__VtrigSched_h2fb1e249__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge axi_master_tb.clk)", 
    ...
    VL_FINISH_MT("axi_master_tb.sv", 177, "");
}
...
VL_INLINE_OPT VlCoroutine Vaxi_master_tb___024root___eval_initial__TOP__Vtiming__1(Vaxi_master_tb___024root* vlSelf) {
    ...
    co_await vlSelf->__VdlySched.delay(0x4c4b40ULL, 
                                       ...
                                       181);
    VL_WRITEF("[%0t] %%Fatal: axi_master_tb.sv:182: Assertion failed in %Naxi_master_tb: timeout\n",
              64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
    VL_STOP_MT("axi_master_tb.sv", 182, "");
}
