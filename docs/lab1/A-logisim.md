...
&emsp;&emsp;Java SE下载链接：<a href="https://www.oracle.com/java/technologies/javase-downloads.html" target="_blank">Java Downloads-ORACLE</a>。（如果双击打开Logisim能正常运行，则无需下载安装）
